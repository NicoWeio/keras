...
class GroupNormalization(Layer):
    ...
    Call arguments:
      ...
      mask: The mask parameter is a binary tensor that indicates which positions
        in the input tensor should be used to compute the mean and variance.
        Masked positions are still normalized, but they are not used to compute
